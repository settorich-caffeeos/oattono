...
- ✅ **ระบบสมาชิก** — สมัคร / login / โปรไฟล์ (Supabase Auth + RLS)
- ✅ **บังคับ login** ก่อนใช้หน้า AI (chat / modules / roi / projects / knowledge)
- ✅ **โครงการ & เอกสารผูกกับบัญชีผู้ใช้** บน Supabase (ข้ามอุปกรณ์ได้)
- ✅ **Export DOCX / PPTX / PDF** จริง (นอกเหนือจาก Markdown)
- ✅ **RAG คลังความรู้องค์กร** — เพิ่มเอกสารภายในให้ AI อ้างอิงตอนสร้าง/ตอบ (lexical retrieval)
- ✅ **Presentation Builder v2** — AI ออกแบบสไลด์ (JSON) + พรีวิว/present mode + export PPTX/PDF, สร้างจากหัวข้อหรือจากเอกสารในโครงการ
- ✅ **กราฟบนหน้าเว็บ** — ROI แสดง bar chart + กราฟกระแสเงินสะสม (จุดคืนทุน)
- ✅ **อัปโหลด PDF/DOCX/TXT** ดูดข้อความเข้าคลังความรู้และช่องข้อความในโมดูล (เช่น Meeting)
- ✅ **ป้องกัน API** — บังคับ login เรียก AI (เมื่อเปิด Supabase) + rate limit ต่อผู้ใช้/IP

**แนะนำให้เพิ่มต่อ**
- **SSO / Azure AD** (ตอนนี้ใช้ email+password ของ Supabase)
- **RAG แบบ Vector (pgvector + embeddings)** — ปัจจุบันเป็น lexical retrieval; อัปเกรดเป็น
  embeddings (เช่น Voyage/OpenAI) เพื่อความแม่นยำสูงขึ้น
